					...
					<Stack className={'section'} style={{ height: user.memberType === 'AGENT' ? '228px' : '153px' }}>
						...
						<List className={'sub-section'}>
							{user.memberType === 'AGENT' && (
								<>
									<ListItem className={pathname === 'addJewellery' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'addJewellery' },
											}}
											scroll={false}
										>
											<div className={'flex-box'}>
												{category === 'addJewellery' ? (
									...
									<ListItem className={pathname === 'myJewelleries' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'myJewelleries' },
											}}
											scroll={false}
										>
											<div className={'flex-box'}>
